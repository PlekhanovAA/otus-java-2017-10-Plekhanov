...
public class DbDispatcher {
    ...
    public void startDb(MessageSystemContext messageSystemContext, Address address, CacheEngineImpl cacheEngine) {
        dbService = new DBServiceImpl(messageSystemContext, address, cacheEngine);
